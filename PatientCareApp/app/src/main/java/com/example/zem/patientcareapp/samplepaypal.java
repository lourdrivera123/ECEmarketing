...
//        items = productsInCart.toArray(items);
//
//        final BigDecimal subtotal = PayPalItem.getItemTotal(items); // Total amount
//        final BigDecimal shipping = new BigDecimal("0.0");         // If you have shipping cost, add it here
//        final BigDecimal tax = new BigDecimal("0.0");         // If you have tax, add it here
//
...
//        ConvertCurrencyRequest.send(hashMap, new RespondListener<JSONObject>() {
//            @Override
//            public PayPalPayment getResult(JSONObject response) {
